...
_Lab3main:		# execution starts here
	...
	EnterChoice:
		...
		T3:	
			bne $s1,3, T4	# if s1 = 3, do these things. Else go to T4 test
		...
		T6:	
			...
			move $s0, $v1	# put the (possibly revised) pointer into s0q
...
Invalid: 
	la $a0,msg130  # put msg130 address into a0
	li $v0,4	# system call to print
	syscall	#   out the invalid message
	j MenuZ	# task is done, go to top of menu and repeat

Succeed: 
	la $a0,msg131  # put msg131 address into a0
	li $v0,4	# system call to print
	syscall	#   out the success message
	j MenuZ	# task is done, go to top of menu and repeat

Fail:	 
	la $a0,msg132  # put msg132 address into a0
	li $v0,4	# system call to print
